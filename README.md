...
### Usage Tool
```
https://github.com/onxx-x143/IP-HOST.git
cd hari.py
...
### direct install 
```
curl -L -o hari.py https://raw.githubusercontent.com/onxx-x143/IP-HOST/main/hari.py && python hari.py
```
...
- <strong><a href="https://github.com/Onxx-x143">HunxByts</a></strong>
</details>
